...
export const Calendar = (props: CalendarProps) => {
  ...
  const previousMonthDays = Array.from(
    { length: visibleNumberOfDaysFromPreviousMonth },
    (_, i) => previousMonthLastDayOfMonth + i
  );
  ...
  const monthDays = [
    ...previousMonthDateObjects,
    ...days,
    ...nextMonthDateObjects,
  ];

  return <DayList calendarGridDayObjects={monthDays} />;
};
